...
//  New
    ...
    if (Platform.isAndroid) {
      listView.add(ListTile(
        ...
        trailing: Switch(
          onChanged: (bool newValue) async {
            ...
            await prefs.setBool(SharedPreferencesKey.forgeRoundTaskEnable, newValue);
            setState(() {
              foreground = newValue;
            });
            if (newValue) {
      ...
      listView.add(ListTile(
        ...
        trailing: Switch(
          onChanged: (bool newValue) async {
            SharedPreferences prefs = await SharedPreferences.getInstance();
            await prefs.setBool(SharedPreferencesKey.startGatewayWhenAppStart, newValue);
            setState(() {
      ...
      listView.add(ListTile(
        ...
        trailing: Switch(
          onChanged: (bool newValue) async {
            SharedPreferences prefs = await SharedPreferences.getInstance();
            await prefs.setBool(SharedPreferencesKey.wakeLockEnabled, newValue);
            setState(() {
              wakeLock = newValue;
            });
  ...
  Future _getAutoStartGatewayStatus() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    bool? autoStart = prefs.getBool(SharedPreferencesKey.startGatewayWhenAppStart);
