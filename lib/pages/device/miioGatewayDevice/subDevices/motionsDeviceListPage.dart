...
class MotionsDeviceListPage extends StatefulWidget {
  MotionsDeviceListPage({Key key, this.device}) : super(key: key);

  Device device;

  @override
  _MotionsDeviceListPageState createState() => _MotionsDeviceListPageState();
}

class _MotionsDeviceListPageState extends State<MotionsDeviceListPage> {
