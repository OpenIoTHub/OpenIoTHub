...
class SensorsDeviceListPage extends StatefulWidget {
  SensorsDeviceListPage({Key key, this.device}) : super(key: key);

  Device device;

  @override
  _SensorsDeviceListPageState createState() => _SensorsDeviceListPageState();
}

class _SensorsDeviceListPageState extends State<SensorsDeviceListPage> {
