...
class MagnetsDeviceListPage extends StatefulWidget {
  MagnetsDeviceListPage({Key key, this.device}) : super(key: key);

  Device device;

  @override
  _MagnetsDeviceListPageState createState() => _MagnetsDeviceListPageState();
}

class _MagnetsDeviceListPageState extends State<MagnetsDeviceListPage> {
