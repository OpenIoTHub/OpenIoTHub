...
import 'package:openiothub/plugins/pages/media/network_video_player_page.dart';
...
class _FileManagerPageState extends State<FileManagerPage> {
  ...
  static String _casaSideBarLabel(int index, OpenIoTHubLocalizations l10n) {
    switch (index) {
      case 0:
        return l10n.nas_files_sidebar_root;
      case 1:
        return l10n.nas_files_sidebar_data;
      case 2:
  ...
  Widget _buildPaginationSideBar(BuildContext context) {
    ...
    for (var i = 0; i < _sidePathRoutes.length; i++) {
      list.add(SideItemProps(
        index: i,
        label: _casaSideBarLabel(i, l10n),
        value: i,
      ));
    }
