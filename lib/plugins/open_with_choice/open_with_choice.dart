...
import 'package:openiothub/plugins/mdns_service/services/aria2c.dart' show Aria2Page;
...
import 'package:openiothub/plugins/mdns_service/services/ssh/ssh_page.dart'
    show SSHNativePage;
import 'package:openiothub/plugins/mdns_service/services/vncrfb_web_page.dart'
    show VNCWebPage;
...
class OpenWithChoice extends StatelessWidget {
  ...
  Future<void> _pushPluginThenDismiss(
    ...
    final opened = await ctx.pushPluginInvoke(
      service.pluginInvoke(modelId),
      ensureInvokeParams: true,
    );
    if (opened) {
