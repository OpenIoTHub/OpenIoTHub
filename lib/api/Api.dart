class Api {
  ...
  // 资讯列表
  static final String newsList = "http://osc.nat-cloud.com/news/list";
  ...
  // 添加到小黑屋
  static final String addToBlack = "http://osc.nat-cloud.com/black/add";

  // 查询小黑屋
  static final String queryBlack = "http://osc.nat-cloud.com/black/query";

  // 从小黑屋中删除
  static final String deleteBlack = "http://osc.nat-cloud.com/black/delete";

  // 开源活动
  static final String eventList = "http://osc.nat-cloud.com/events/";
}