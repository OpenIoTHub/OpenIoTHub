...
abstract class OpenIoTHubLocalizations {
  ...
  /// No description provided for @common_username_and_password_cant_be_empty.
  ///
  /// In zh, this message translates to:
  /// **'用户名与密码不能为空'**
  ...
  /// No description provided for @common_privacy_policy.
  ///
  /// In zh, this message translates to:
  /// **'隐私政策'**
  String get common_privacy_policy;

  /// No description provided for @common_feedback_channels.
  ///
  /// In zh, this message translates to:
  /// **'反馈渠道'**
  ...
  /// No description provided for @common_login_failed.
  ///
  /// In zh, this message translates to:
  /// **'登录失败'**
  String get common_login_failed;
  ...
  /// No description provided for @common_add_gateway_success.
  ///
  /// In zh, this message translates to:
  /// **'网关的id与token已经复制到剪切板，请将剪切板的配置填写到网关的配置文件中'**
  ...
  /// No description provided for @plugin_add_gateway_success.
  ///
  /// In zh, this message translates to:
  /// **'添加网关成功！'**
  String get plugin_add_gateway_success;

  /// No description provided for @plugin_login_failed.
  ///
  /// In zh, this message translates to:
  /// **'登录失败！'**
  String get plugin_login_failed;

  /// No description provided for @plugin_add_gateway_failed.
  ///
  /// In zh, this message translates to:
  /// **'添加网关失败！'**
  ...
  /// No description provided for @plugin_confirm.
  ///
  /// In zh, this message translates to:
  /// **'确认'**
  String get plugin_confirm;
  ...
  /// No description provided for @plugin_confirm_delete_device.
  ///
  /// In zh, this message translates to:
  /// **'确认删除本设备?'**
  String get plugin_confirm_delete_device;

  /// No description provided for @plugin_delete_success.
  ///
  /// In zh, this message translates to:
  /// **'删除成功!'**
  ...
  /// No description provided for @plugin_username_and_password_cant_be_empty.
  ///
  /// In zh, this message translates to:
  /// **'用户名和密码不可以为空'**
